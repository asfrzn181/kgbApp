...
// 4. TAMPILAN UTAMA (FIXED V-ELSE BUG)
                                        ...
                                        <td colspan="6" class="p-3 ps-5">
                                            <div class="row g-3 small">
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="mb-1"><i class="bi bi-building me-2"></i> {{ item.unit_kerja }}</div>
                        ...
                        <div class="card shadow-sm border-0 mb-3">
                            ...
                            <div class="card-body">
                                <div class="row g-3">
                                    ...
                                    <div class="col-12 col-md-6"><label class="form-label small text-muted">Perangkat Daerah</label><input v-model="form.perangkat_daerah" class="form-control"></div>
