 ...
 * 2. Setelah halaman SIASN terbuka, tunggu atau klik bookmark "SIASN → KGB"
 * 3. Bookmarklet akan otomatis: isi NIP, klik Cari, navigasi tab Data Pribadi & Posisi & Jabatan
 *    untuk mengambil semua data, lalu kirim balik ke KGB App
 * ============================================================
 */
...
const BOOKMARKLET_URL = buildBookmarklet();
